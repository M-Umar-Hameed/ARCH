    ...
    <div className="glass-card rounded-xl overflow-hidden border border-white/10 flex flex-col group hover:border-primary/30 transition-all duration-300">
      <div className="p-6 border-b border-white/5 bg-surface-container/30 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-xs text-on-surface-variant">Identities and API keys. Every human and AI agent acts under an actor: its key authenticates REST/MCP calls, every work order change is attributed to it in the audit trail, and its role (admin/member) gates powerful actions. Mint one key per agent; revoke any key to cut that agent off. Applies to ALL projects. These are VibeOps API keys for agents/humans calling VibeOps itself — not AI provider accounts. To connect an AI CLI (Claude, Codex, Antigravity, etc.), see Settings &gt; AI Models &gt; AI Accounts.</p>
        </div>
      </div>
